...
namespace TestFramework
{
    ...
    void TestBegin(const char* file) { fprintf(stderr, "START: %s\n", file); }

    void TestEnd(const char* file) { fprintf(stderr, "END: %s\n", file); }

    void TestAbort(const char* file, int line) { fprintf(stderr, "ABORT: %s:%d\n", file, line); }
