...
typedef errorcode_t (*exec_handler_t)(vmspace_t* vs, struct DENTRY* dentry, addr_t* exec_addr, register_t* exec_arg);
...
errorcode_t exec_load(vmspace_t* vs, struct DENTRY* dentry, addr_t* exec_addr, register_t* exec_arg);
