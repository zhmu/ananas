...
constexpr int
to_atomic_memorder(const memory_order mo)
{
	switch(mo) {
...
public:
	...
	{
		return __atomic_compare_exchange(&a_value, &expected, &desired, true, detail::to_atomic_memorder(success), detail::to_atomic_memorder(failure));
	}
	...
	{
		return __atomic_compare_exchange(&a_value, &expected, &desired, false, detail::to_atomic_memorder(success), detail::to_atomic_memorder(failure));
	}
