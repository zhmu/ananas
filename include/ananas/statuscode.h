...
static inline statuscode_t ananas_statuscode_make_failure(unsigned int fileid, unsigned int line, unsigned int no) {
	return (1 << 31) | (fileid << 20) | (line << 9) | no;
}

static inline int ananas_statuscode_is_success(unsigned int val)
{
