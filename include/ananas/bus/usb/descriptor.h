...
#define USB_REQUEST_CLEAR_HUB_FEATURE \
	USB_REQUEST_MAKE( \
		USB_CONTROL_REQ_TYPE(USB_CONTROL_TYPE_CLASS) | USB_CONTROL_REQ_RECIPIENT(USB_CONTROL_RECIPIENT_DEVICE), \
		USB_CONTROL_REQUEST_CLEAR_FEATURE \
	)
#define USB_REQUEST_CLEAR_PORT_FEATURE \
	USB_REQUEST_MAKE( \
		USB_CONTROL_REQ_TYPE(USB_CONTROL_TYPE_CLASS) | USB_CONTROL_REQ_RECIPIENT(USB_CONTROL_RECIPIENT_OTHER), \
		USB_CONTROL_REQUEST_CLEAR_FEATURE \
	)
#define USB_REQUEST_GET_BUS_STATE \
	USB_REQUEST_MAKE( \
		USB_CONTROL_REQ_DEV2HOST | USB_CONTROL_REQ_TYPE(USB_CONTROL_TYPE_CLASS) | USB_CONTROL_REQ_RECIPIENT(USB_CONTROL_RECIPIENT_OTHER), \
		USB_CONTROL_REQUEST_GET_STATE \
	)
#define USB_REQUEST_GET_HUB_DESCRIPTOR \
	USB_REQUEST_MAKE( \
		USB_CONTROL_REQ_DEV2HOST | USB_CONTROL_REQ_TYPE(USB_CONTROL_TYPE_CLASS) | USB_CONTROL_REQ_RECIPIENT(USB_CONTROL_RECIPIENT_DEVICE), \
