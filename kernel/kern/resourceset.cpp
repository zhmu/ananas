...
const Resource* ResourceSet::GetResource(const Resource::Type& type, size_t index) const
{
...
void* ResourceSet::AllocateResource(
    const Resource::Type& type, Resource::Length length, size_t index)
{
...
bool ResourceSet::AddResource(const Resource& resource)
{
    ...
    for (const Resource& res : rs_Resource) {
        ...
        switch (res.r_Type) {
            ...
            case Resource::RT_IO:
                ...
                hex = true;
                break;
            case Resource::RT_IRQ:
                kprintf("irq ");
                break;
            case Resource::RT_ChildNum:
                kprintf("child ");
                break;
            case Resource::RT_PCI_Bus:
                kprintf("bus ");
                break;
            case Resource::RT_PCI_Device:
                kprintf("dev ");
                break;
            case Resource::RT_PCI_Function:
                kprintf("func ");
                break;
            case Resource::RT_PCI_VendorID:
                kprintf("vendor ");
                hex = true;
                break;
            case Resource::RT_PCI_DeviceID:
                kprintf("device ");
                hex = true;
                break;
            case Resource::RT_PCI_ClassRev:
                kprintf("class/revision ");
                break;
            default:
                continue;
        }
