...
Result
sys_statfs(Thread* t, const char* path, struct statfs* buf)
{
...
Result
sys_fstatfs(Thread* t, fdindex_t hindex, struct statfs* buf)
{
...
Result
sys_mount(Thread* t, const char* type, const char* source, const char* dir, int flags)
{
...
Result
sys_unmount(Thread* t, const char* dir, int flags)
{
