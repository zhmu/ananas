...
acpi_process_resources(ACPI_HANDLE ObjHandle, ResourceSet& resourceSet)
{
    ...
    resourceSet.AddResource(
        Resource(Resource::RT_ACPI_HANDLE, reinterpret_cast<Resource::Base>(ObjHandle), 0));
    ...
    if (Info->HardwareId.String != NULL && Info->HardwareId.Length >= ACPI_EISAID_STRING_SIZE &&
        ...
        unsigned int pnpid =
            (unsigned int)strtoul(Info->HardwareId.String + 3 /* skip PNP */, NULL, 16);
        ...
        switch (res->Type) {
            ...
            case ACPI_RESOURCE_TYPE_IRQ:
                ...
                for (int i = 0; i < res->Data.Irq.InterruptCount; i++) {
                    ...
                    resourceSet.AddResource(
                        Resource(Resource::RT_IRQ, res->Data.Irq.Interrupts[i], 0));
                }
                ACPI_DPRINTF("\n");
                break;
            case ACPI_RESOURCE_TYPE_IO:
                ...
                resourceSet.AddResource(
                    Resource(Resource::RT_IO, res->Data.Io.Minimum, res->Data.Io.AddressLength));
                break;
            case ACPI_RESOURCE_TYPE_ADDRESS16:
                ...
                resourceSet.AddResource(Resource(
                    Resource::RT_Memory, res->Data.Address16.Minimum,
                    res->Data.Address16.AddressLength));
                break;
            case ACPI_RESOURCE_TYPE_ADDRESS32:
                ...
                resourceSet.AddResource(Resource(
                    Resource::RT_Memory, res->Data.Address32.Minimum,
                    res->Data.Address32.AddressLength));
                break;
        }
    }
