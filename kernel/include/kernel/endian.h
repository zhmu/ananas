...
static inline uint16_t _swap16(uint16_t v) { return (v >> 8) | (v & 0xff) << 8; }
...
static inline uint16_t htole16(uint16_t v) { return BIG_OR_LITTLE(_swap16(v), v); }

static inline uint32_t htole32(uint16_t v) { return BIG_OR_LITTLE(_swap32(v), v); }

static inline uint32_t htobe16(uint16_t v) { return BIG_OR_LITTLE(v, _swap16(v)); }

static inline uint32_t htobe32(uint16_t v) { return BIG_OR_LITTLE(v, _swap32(v)); }
