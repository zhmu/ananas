...
static void putnumber(void (*putch)(void*, int), void* v, uintmax_t i)
{
...
static void putint(void (*putch)(void*, int), void* v, unsigned int n)
{
    /*
...
static void printf_putch(void* v, int c) { write(STDOUT_FILENO, &c, 1); }

void vaprintf(const char* fmt, va_list ap) { vapprintf(fmt, printf_putch, NULL, ap); }
