...
/*
 * We use pointers to avoid any userland dependency on their size/layout; also,
 * at least some software (LLVM) depends on being able to compare these using <
 * instead of pthread_equal().
 */
