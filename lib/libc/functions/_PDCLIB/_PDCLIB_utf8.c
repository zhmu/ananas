...
static bool utf8_mbsinit(const mbstate_t* p_s) { return p_s->_StUC[0] == 0; }
...
#define START_CONVERSION bool result = true;
...
static bool utf8toc32(
    ...
    const char* restrict* restrict p_inbuf, size_t* restrict p_insz, mbstate_t* restrict p_s)
{
    START_CONVERSION
...
static bool c32toutf8(
    ...
    const char32_t* restrict* restrict p_inbuf, size_t* restrict p_insz, mbstate_t* restrict p_s)
{
    START_CONVERSION
    while (*p_outsz) {
