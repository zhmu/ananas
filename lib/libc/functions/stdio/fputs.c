...
int _PDCLIB_fputs_unlocked(const char* _PDCLIB_restrict s, FILE* _PDCLIB_restrict stream)
{
...
int fputs_unlocked(const char* _PDCLIB_restrict s, FILE* _PDCLIB_restrict stream)
{
