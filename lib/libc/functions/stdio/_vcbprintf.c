...
static inline bool cbout(struct _PDCLIB_status_t* status, const char* buf, size_t size)
{
...
int _vcbprintf(
    void* p, size_t (*cb)(void* p, const char* buf, size_t size), const char* format, va_list arg)
{
