...
*/
size_t
strxfrm(char* _PDCLIB_restrict s1, const char* _PDCLIB_restrict s2, size_t n) _PDCLIB_nothrow;
...
size_t strlcpy(char* _PDCLIB_restrict _Dst, const char* _PDCLIB_restrict _Src, size_t _DstSize)
    _PDCLIB_nothrow;

size_t strlcat(char* _PDCLIB_restrict _Dst, const char* _PDCLIB_restrict _Src, size_t _DstSize)
    _PDCLIB_nothrow;
#endif
