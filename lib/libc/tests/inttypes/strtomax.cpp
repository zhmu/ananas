...
TEST(inttypes, strtoimax)
{
    struct IMaxRanges {
        ...
        static constexpr intmax_t Overflow() {
            return INTMAX_MIN;
        }

        static constexpr const char* MaxStringHex() {
            return MAX_S_STRING_HEX;
        }

        static constexpr const char* MaxStringHexPlus1() {
            return MAX_S_STRING_HEX_PLUS_1;
        }

        static constexpr const char* MaxStringDec() {
            return MAX_S_STRING_DEC;
        }

        static constexpr const char* MaxStringDecPlus1() {
            return MAX_S_STRING_DEC_PLUS_1;
        }

        static constexpr const char* MinStringDec() {
            return MIN_S_STRING_DEC;
        }

        static constexpr const char* MinStringDecMinus1() {
            return MIN_S_STRING_DEC_MINUS_1;
        }

        static constexpr const char* MinStringHex() {
            return MIN_S_STRING_HEX;
        }

        static constexpr const char* MinStringHexMinus1() {
            return MIN_S_STRING_HEX_MINUS_1;
        }
...
{
    struct UIMaxRanges {
        static constexpr uintmax_t Max() {
            return UINTMAX_MAX;
        }
        static constexpr uintmax_t Overflow() {
            return UINTMAX_MAX;
        }
