...
TEST(stdio, pdclib_filemode)
{
    ...
    EXPECT_EQ(
        (_PDCLIB_FAPPEND | _PDCLIB_FWRITE | _PDCLIB_FRW | _PDCLIB_FBIN), _PDCLIB_filemode("a+b"));
    ...
    EXPECT_EQ(
        (_PDCLIB_FAPPEND | _PDCLIB_FWRITE | _PDCLIB_FRW | _PDCLIB_FBIN), _PDCLIB_filemode("ab+"));
