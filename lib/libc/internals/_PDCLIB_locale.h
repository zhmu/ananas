...
static inline void _PDCLIB_setthreadlocale(locale_t l) { _PDCLIB_locale_tls = l; }
#else
...
{
    _PDCLIB_wcinfo_t* info = (_PDCLIB_wcinfo_t*)bsearch(
        &num, l->_WCType, l->_WCTypeSize, sizeof(l->_WCType[0]), _PDCLIB_wcinfo_cmp);
