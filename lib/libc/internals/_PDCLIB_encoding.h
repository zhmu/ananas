...
static inline int _PDCLIB_c16rtoc32(
    _PDCLIB_char32_t* _PDCLIB_restrict out, const _PDCLIB_char16_t* _PDCLIB_restrict in,
    _PDCLIB_size_t bufsize, _PDCLIB_mbstate_t* _PDCLIB_restrict ps)
{
    if (ps->_Surrogate) {
...
static inline _PDCLIB_size_t _PDCLIB_c32rtoc16(
    _PDCLIB_wchar_t* _PDCLIB_restrict out, const _PDCLIB_char32_t* _PDCLIB_restrict in,
    _PDCLIB_size_t bufsize, _PDCLIB_mbstate_t* _PDCLIB_restrict ps)
{
    if (ps->_Surrogate) {
        *out = ps->_Surrogate;
...
struct _PDCLIB_charcodec_t {
    ...
    _PDCLIB_bool (*__mbstoc32s)(
        ...
        _PDCLIB_size_t* _PDCLIB_restrict _P_insz, _PDCLIB_mbstate_t* _PDCLIB_restrict _P_ps);
...
size_t mbrtoc16_l(
    char16_t* _PDCLIB_restrict pc16, const char* _PDCLIB_restrict s, size_t n,
    mbstate_t* _PDCLIB_restrict ps, _PDCLIB_locale_t _PDCLIB_restrict l);

size_t c16rtomb_l(
    char* _PDCLIB_restrict s, char16_t c16, mbstate_t* _PDCLIB_restrict ps,
    _PDCLIB_locale_t _PDCLIB_restrict l);

size_t mbrtoc32_l(
    char32_t* _PDCLIB_restrict pc32, const char* _PDCLIB_restrict s, size_t n,
    mbstate_t* _PDCLIB_restrict ps, _PDCLIB_locale_t _PDCLIB_restrict l);

size_t c32rtomb_l(
    char* _PDCLIB_restrict s, char32_t c32, mbstate_t* _PDCLIB_restrict ps,
    _PDCLIB_locale_t _PDCLIB_restrict l);
