...
#define _PDCLIB_FP_SINGLE_RADIX 2.0
...
#define _PDCLIB_FLT_RADIX \
    _PDCLIB_concat(_PDCLIB_concat3(_PDCLIB_FP_, _PDCLIB_FLOAT_TYPE, _RADIX), f)
...
#define _PDCLIB_FLT_EPSILON \
    _PDCLIB_concat(_PDCLIB_concat3(_PDCLIB_FP_, _PDCLIB_FLOAT_TYPE, _EPSILON), f)
...
#define _PDCLIB_LDBL_RADIX \
    _PDCLIB_concat(_PDCLIB_concat3(_PDCLIB_FP_, _PDCLIB_LDOUBLE_TYPE, _RADIX), l)
...
#define _PDCLIB_LDBL_EPSILON \
    _PDCLIB_concat(_PDCLIB_concat3(_PDCLIB_FP_, _PDCLIB_LDOUBLE_TYPE, _EPSILON), l)
