...
_PDCLIB_uintmax_t _PDCLIB_strtox_main(
    const char** p, unsigned int base, _PDCLIB_uintmax_t error, _PDCLIB_uintmax_t limval,
...
_Static_assert(
    sizeof(long long) == _PDCLIB_LLONG_BYTES, "Compiler disagrees on _PDCLIB_LLONG_BYTES.");
