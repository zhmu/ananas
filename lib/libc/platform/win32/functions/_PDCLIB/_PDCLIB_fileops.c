...
static bool readf(_PDCLIB_fd_t self, void* buf, size_t length, size_t* numBytesRead)
{
...
static bool writef(_PDCLIB_fd_t self, const void* buf, size_t length, size_t* numBytesWritten)
{
    DWORD dwLen = length > INT32_MAX ? INT32_MAX : length;
...
static void closef(_PDCLIB_fd_t self) { CloseHandle(self.pointer); }
