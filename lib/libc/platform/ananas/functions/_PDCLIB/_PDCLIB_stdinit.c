...
static FILE _PDCLIB_sout = {.ops = &_PDCLIB_fileops,
                            .handle = {.sval = 1},
                            ...
                            .filename = NULL,
                            .next = &_PDCLIB_serr};
static FILE _PDCLIB_sin = {.ops = &_PDCLIB_fileops,
                           .handle = {.sval = 0},
...
static const _PDCLIB_ctype_t global_ctype[] = {
    ...
    {/* 'A' */ _PDCLIB_CTYPE_GRAPH | _PDCLIB_CTYPE_ALPHA | _PDCLIB_CTYPE_UPPER |
         _PDCLIB_CTYPE_XDIGT,
     0x41, 0x61, 0x41},
    {/* 'B' */ _PDCLIB_CTYPE_GRAPH | _PDCLIB_CTYPE_ALPHA | _PDCLIB_CTYPE_UPPER |
         _PDCLIB_CTYPE_XDIGT,
     0x42, 0x62, 0x42},
    {/* 'C' */ _PDCLIB_CTYPE_GRAPH | _PDCLIB_CTYPE_ALPHA | _PDCLIB_CTYPE_UPPER |
         _PDCLIB_CTYPE_XDIGT,
     0x43, 0x63, 0x43},
    {/* 'D' */ _PDCLIB_CTYPE_GRAPH | _PDCLIB_CTYPE_ALPHA | _PDCLIB_CTYPE_UPPER |
         _PDCLIB_CTYPE_XDIGT,
     0x44, 0x64, 0x44},
    {/* 'E' */ _PDCLIB_CTYPE_GRAPH | _PDCLIB_CTYPE_ALPHA | _PDCLIB_CTYPE_UPPER |
         _PDCLIB_CTYPE_XDIGT,
     0x45, 0x65, 0x45},
    {/* 'F' */ _PDCLIB_CTYPE_GRAPH | _PDCLIB_CTYPE_ALPHA | _PDCLIB_CTYPE_UPPER |
         _PDCLIB_CTYPE_XDIGT,
     0x46, 0x66, 0x46},
    ...
    {/* 'a' */ _PDCLIB_CTYPE_GRAPH | _PDCLIB_CTYPE_ALPHA | _PDCLIB_CTYPE_LOWER |
         _PDCLIB_CTYPE_XDIGT,
     0x41, 0x61, 0x61},
    {/* 'b' */ _PDCLIB_CTYPE_GRAPH | _PDCLIB_CTYPE_ALPHA | _PDCLIB_CTYPE_LOWER |
         _PDCLIB_CTYPE_XDIGT,
     0x42, 0x62, 0x62},
    {/* 'c' */ _PDCLIB_CTYPE_GRAPH | _PDCLIB_CTYPE_ALPHA | _PDCLIB_CTYPE_LOWER |
         _PDCLIB_CTYPE_XDIGT,
     0x43, 0x63, 0x63},
    {/* 'd' */ _PDCLIB_CTYPE_GRAPH | _PDCLIB_CTYPE_ALPHA | _PDCLIB_CTYPE_LOWER |
         _PDCLIB_CTYPE_XDIGT,
     0x44, 0x64, 0x64},
    {/* 'e' */ _PDCLIB_CTYPE_GRAPH | _PDCLIB_CTYPE_ALPHA | _PDCLIB_CTYPE_LOWER |
         _PDCLIB_CTYPE_XDIGT,
     0x45, 0x65, 0x65},
    {/* 'f' */ _PDCLIB_CTYPE_GRAPH | _PDCLIB_CTYPE_ALPHA | _PDCLIB_CTYPE_LOWER |
         _PDCLIB_CTYPE_XDIGT,
     0x46, 0x66, 0x66},
