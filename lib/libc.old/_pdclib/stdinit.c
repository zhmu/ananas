...
struct lconv _PDCLIB_lconv = { 
    ...
    {
        /* no error 	*/ (char *)"",
        /* E2BIG	*/ (char*)"Argument list too long",
        /* EACCES	*/ (char*)"Permission denied",
        /* EADDRINUSE	*/ (char*)"Address already in use",
        /* EADDRNOTAVAIL*/ (char*)"Address not available",
        /* EAFNOSUPPORT	*/ (char*)"Address family not supported",
        /* EAGAIN	*/ (char*)"Resource temporarily unavailable",
        /* EALREADY	*/ (char*)"Connection already in progress",
        /* EBADF	*/ (char*)"Bad file descriptor",
        /* EBADMSG	*/ (char*)"Bad message",
        /* EBUSY	*/ (char*)"Device or resource busy",
        /* ECANCELLED	*/ (char*)"Operation canceled",
        /* ECHILD	*/ (char*)"No child process",
        /* ECONNABORTED	*/ (char*)"Connection aborted",
        /* ECONNREFUSED	*/ (char*)"Connection refused",
        /* ECONNRESET	*/ (char*)"Connection reset",
        /* EDEADLK	*/ (char*)"Resource deadlock avoided",
        /* EDESTADDRREQ	*/ (char*)"Destination address required",
        /* EDOM		*/ (char*)"Mathematics argument out of domain of function",
        /* EDQUOT	*/ (char*)"Disk quota exceeded",
        /* EEXIST	*/ (char*)"File exists",
        /* EFAULT	*/ (char*)"Bad address",
        /* EFBIG	*/ (char*)"File too large",
        /* EHOSTUNREACH	*/ (char*)"Host is unreachable",
        /* EIDRM	*/ (char*)"Identifier removed",
        /* EILSEQ	*/ (char*)"Illegal byte sequence",
        /* EINPROGRESS	*/ (char*)"Operation in progress",
        /* EINTR	*/ (char*)"Interrupted function call",
        /* EINVAL	*/ (char*)"Invalid argument",
        /* EIO		*/ (char*)"Input/output error",
        /* EISCONN	*/ (char*)"Socket is connected",
        /* EISDIR	*/ (char*)"Is a directory",
        /* ELOOP	*/ (char*)"Too many levels of symbolic links",
        /* EMFILE	*/ (char*)"Too many open files",
        /* EMLINK	*/ (char*)"Too many links",
        /* EMSGSIZE	*/ (char*)"Message too long",
        /* EMULTIHOP	*/ (char*)"Multihop attempted",
        /* ENAMETOOLONG	*/ (char*)"Filename too long",
        /* ENETDOWN	*/ (char*)"Network is down",
        /* ENETRESET	*/ (char*)"Connection aborted by network",
        /* ENETUNREACH	*/ (char*)"Network unreachable",
        /* ENFILE	*/ (char*)"Too many open files in system",
        /* ENOBUFS	*/ (char*)"No buffer space available",
        /* ENODATA	*/ (char*)"No message is available",
        /* ENODEV	*/ (char*)"No such device",
        /* ENOENT	*/ (char*)"No such file or directory",
        /* ENOEXEC	*/ (char*)"Exec format error",
        /* ENOLCK	*/ (char*)"No locks available",
        /* ENOLINK	*/ (char*)"Link has been severed",
        /* ENOMEM	*/ (char*)"Not enough space",
        /* ENOPROTOOPT	*/ (char*)"Protocol not available",
        /* ENOSPC	*/ (char*)"No space left on device",
        /* ENOSYS	*/ (char*)"Function not implemented",
        /* ENOTCONN	*/ (char*)"The socket is not connected",
        /* ENOTDIR	*/ (char*)"Not a directory",
        /* ENOTEMPTY	*/ (char*)"Directory not empty",
        /* ENOTTY	*/ (char*)"Inappropiate I/O control operation",
        /* ENXIO	*/ (char*)"No such device or address",
        /* EOPNOTSUPP	*/ (char*)"Operation not supported on socket",
        /* EOVERFLOW	*/ (char*)"Value too large to be stored in data type",
        /* EPERM	*/ (char*)"Operation not permitted",
        /* EPIPE	*/ (char*)"Broken pipe",
        /* EPROTO	*/ (char*)"Protocol error",
        /* EPROTONOSUPPORT	*/ (char*)"Protocol not supported",
        /* EPROTOTYPE	*/ (char*)"Protocol wrong type for socket",
        /* ERANGE	*/ (char*)"Result too large",
        /* EROFS	*/ (char*)"Read-only file system",
        /* ESPIPE	*/ (char*)"Invalid seek",
        /* ESRCH	*/ (char*)"No such process",
        /* ESTALE	*/ (char*)"Stale file handle",
        /* ETIMEDOUT	*/ (char*)"Connection timed out",
        /* ETXTBSY	*/ (char*)"Text file busy",
        /* EWOULDBLOCK	*/ (char*)"Operation would block",
        /* EXDEV	*/ (char*)"Improper link",
    },
    /* decimal_point      */ (char *)".",
    /* thousands_sep      */ (char *)"",
    /* grouping           */ (char *)"",
