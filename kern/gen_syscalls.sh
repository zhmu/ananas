...
$AWK '
	...
	/^[0-9]+/ {
		...
		ARGS = substr($0, index($0, "(") + 1, index($0, "}") - index($0, "(") - 1)
		if (index(ARGS, ")") == 1) {
			# no arguments
			print $3 " sys_" substr($4, 1, index($4, "(")) ");"
		} else {
			print $3 " sys_" substr($4, 1, index($4, "(")) " " ARGS
		}
	}
' < $1 > $3
...
# becomes
#
#   case 1234: sys_foo((int)a->arg1, (int)a->arg2, (int)a->arg3); return Result::Success();
#   case 4321: return sys_bar((int)a->arg1);
#
$AWK '
	/^#/ { next; }
	/^[0-9]+/ {
